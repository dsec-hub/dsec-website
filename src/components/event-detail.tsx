...
/**
 * The full public event page body (everything below the nav). Extracted from the
 * `/events/[slug]` page so the committee's draft-preview route renders the EXACT
 * same layout — a preview is then truly WYSIWYG. Flagship events render their own
 * template (`FlagshipEvent`) and never reach this component.
 */
